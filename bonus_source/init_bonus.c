...
/*   Updated: 2024/03/12 17:55:45 by yhsu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_img	*initialize_img_struct(mlx_t *mlx, t_game *game)
{
	...
	assets = load_enemy_texture(mlx, assets, game);
	assets = load_enemy_up_texture(mlx, assets, game);
	assets = load_enemy_down_texture(mlx, assets, game);
	return (assets);
}
